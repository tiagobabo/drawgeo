...
public class HomeActivity extends Activity{
	...
	// objeto para a liga��o com o Facebook
	final Facebook facebook = new Facebook("374936152553880");
	Boolean loginFacebook = false;
	
	// ecr� de loading para o pedido da informa��o do utilizador
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		fButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				// chamada � fun��o de autentica��o do facebook
				facebook.authorize(HomeActivity.this, new String[] { "email" }, new DialogListener() {

					public void onComplete(Bundle values) {
						// depois de completar o login e a verifica��o das permiss�es da app, passamos a ter acesso � informa��o do jogador
						// requisitamos os dados deste, para sabermos o seu e-mail
						 new AsyncFacebookRunner(facebook).request("/me", 
								...
								public void onComplete(String response,
									...
									// a string est� no formato JSON
									JSONObject obj;
									try {
										obj = Util.parseJson(response);
										
										// retiramos a informa��o que precisamos, neste caso, o email
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        // depois do login, verifica as permiss�es da aplica��o
